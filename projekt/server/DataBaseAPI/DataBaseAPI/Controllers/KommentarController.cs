...
namespace DataBaseAPI.Controllers
{
    ...
    public class KommentarController : ControllerBase
    {
        ...
        public KommentarController(ProjektmanagementContext context)
        {
            _context = context;
        }
    ...
    [HttpGet("{id}")]
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<Kommentar>> DeleteKommentar(int id)
        {
            var kommentar = await _context.Kommentar.FindAsync(id);
            if (kommentar == null)
            {
        ...
        {
            return _context.Kommentar.Any(e => e.KommentarId == id);
        }
    }
}
